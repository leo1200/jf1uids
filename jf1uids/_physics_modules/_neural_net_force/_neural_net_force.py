...
def _neural_net_force(
    ...
    positions_with_time = jnp.concatenate([positions_flat, time_broadcasted], axis=1)  # (N*N, 3)
    ...
    primitive_state = primitive_state.at[registered_variables.velocity_index.x, nc:-nc, nc:-nc].add(forces[0] * time_step)
    primitive_state = primitive_state.at[registered_variables.velocity_index.y, nc:-nc, nc:-nc].add(forces[1] * time_step)
