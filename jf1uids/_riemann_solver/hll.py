...
def _hll_solver3D(primitives_left: STATE_TYPE, primitives_right: STATE_TYPE, gamma: Union[float, Float[Array, ""]], registered_variables: RegisteredVariables, flux_direction_index: int) -> STATE_TYPE:
    ...
    # get the left and right states and fluxes
    fluxes_left = _euler_flux3D(primitives_left, gamma, registered_variables, flux_direction_index)
    fluxes_right = _euler_flux3D(primitives_right, gamma, registered_variables, flux_direction_index)
    ...
    conservatives_right = conserved_state_from_primitive3D(primitives_right, gamma, registered_variables)
