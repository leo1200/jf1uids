...
from jf1uids.physics_modules.stellar_wind import wind_source
...
def add_physical_sources(primitive_state, dt, config, params, helper_data):
    ...
    if config.stellar_wind:
        source_term = wind_source(params.wind_params, primitive_state, helper_data.volumetric_centers, params.dx)
