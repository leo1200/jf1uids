...
from jf1uids._geometry.geometry import CARTESIAN, SPHERICAL
from jf1uids.fluid_equations.registered_variables import RegisteredVariables
from jf1uids.option_classes.simulation_config import SimulationConfig
from jf1uids._riemann_solver.hll import _hll_solver, _hll_solver
...
def _get_conservative_derivative(
    ...
    fluxes = _hll_solver(primitives_left_of_interface, primitives_right_of_interface, gamma, config, registered_variables, flux_direction_index = 1)
