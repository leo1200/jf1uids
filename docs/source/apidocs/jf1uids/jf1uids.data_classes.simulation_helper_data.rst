...
.. py:function:: get_helper_data(config: jf1uids.option_classes.simulation_config.SimulationConfig, sharding: typing.Union[types.NoneType, jax.NamedSharding] = None, padded: bool = False, production: bool = False) -> jf1uids.data_classes.simulation_helper_data.HelperData
