...
class Weaver:
    ...
    # def years_to_code_units(years, UnitVelocity_in_cm_per_s, UnitLength_in_cm):
    #     UnitTime_in_s = UnitLength_in_cm / UnitVelocity_in_cm_per_s
    #     return years * 3600 * 24 * 365.25 / UnitTime_in_s

    # def solar_masses_to_code_units(mass, UnitMass_in_g):
    #     return mass * M_sun.to("g").value / UnitMass_in_g
    
    # def km_s_to_code_units(velocity, UnitVelocity_in_cm_per_s):
    #     return velocity * 1e5 / UnitVelocity_in_cm_per_s

    # def init_from_astro_to_code_units(v_inf, M_dot, rho_0, UnitLength_in_cm, UnitMass_in_g, UnitVelocity_in_cm_per_s):
    #     v_inf = Weaver.km_s_to_code_units(v_inf, UnitVelocity_in_cm_per_s)
    #     M_dot = Weaver.solar_masses_to_code_units(M_dot, UnitMass_in_g) / Weaver.years_to_code_units(1, UnitVelocity_in_cm_per_s, UnitLength_in_cm)
    #     print(M_dot)
    #     rho_0 = rho_0 # assume to be in code units
    #     return Weaver(v_inf, M_dot, rho_0)
