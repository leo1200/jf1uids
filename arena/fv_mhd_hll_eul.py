...
from jf1uids.option_classes.simulation_config import DOUBLE_PRECISION, FINITE_DIFFERENCE, FINITE_VOLUME, HLL, IMPLICIT_EULER, LAX_FRIEDRICHS, PERIODIC_ROLL, SINGLE_PRECISION
