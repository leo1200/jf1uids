...
from jf1uids.option_classes.simulation_config import DOUBLE_PRECISION, FINITE_DIFFERENCE, FINITE_VOLUME, LAX_FRIEDRICHS, PERIODIC_ROLL, SINGLE_PRECISION
...
# blast test 1
mhd_blast_test1(
    config = base_config._replace(num_cells=356),
    params = base_params,
